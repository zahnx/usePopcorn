...
function MovieDetais({ selectedId, onCloseMovie, onWatched, watched }) {
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>This movie is rated as {watchedUserRating} ⭐</p>
              )}
            </div>
            <p>
              <em>{plot}</em>
